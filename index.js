...
const {EditBlockCoder} = require("./coders/editblock_coder");
    ...
    function create(main_model = null, edit_format = null, io = null, from_coder = null, kwargs = {}) {
        const { EditBlockCoder, EditBlockFencedCoder, UnifiedDiffCoder, WholeFileCoder } = require("./coders");
        ...
        if (from_coder) {
            let use_kwargs = {...from_coder.original_kwargs};  // copy orig kwargs
            ...
            use_kwargs = {...use_kwargs, ...update, ...kwargs};  // override to complete the switch and passed kwargs
